# This extension assumes we have a mesh object in edit-mode. See also the Tooltip

bl_info = {
    "name": "Area Lights From Faces",
    "author": "Anthony Aragues <https://blendermarket.com/products/area-lights>",
    "version": (1, 2, 0),
    "blender": (4, 2, 0),
    "location": "View3D > Panels > Lights",
    "description": "Creates Area Lights From Selected Faces.",
    "category": "Lighting"
}
