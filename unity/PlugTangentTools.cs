...
// this script works like merge in distance in blender and then the result is written into the 
// tangents of the mesh as an override */
...
{
    [MenuItem("Tools/Reconstruct Tangents with Split Normals")]
